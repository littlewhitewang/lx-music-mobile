/* eslint-disable @typescript-eslint/no-confusing-void-expression, @typescript-eslint/prefer-readonly, @typescript-eslint/no-unsafe-argument, @typescript-eslint/promise-function-async, @typescript-eslint/no-implied-eval, no-new-func */
